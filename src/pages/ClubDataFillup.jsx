          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, memberFormLink: e.target.value })
                }
              />
            </div>
              ...
              <div key={role} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full p-2 border rounded-md"
                    value={
                      formData[`${role.toLowerCase().replace("-", "")}Name`]
                    }
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        [`${role.toLowerCase().replace("-", "")}Name`]:
                          e.target.value,
                      })
                    }
                  />
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    value={
                      formData[
                        `${role.toLowerCase().replace("-", "")}Description`
                      ]
                    }
                    onChange={(e) =>
                      setFormData({
