...
const Footer = () => {
  return (
    <footer className="bg-[#263238] text-gray-300 py-10 flex justify-center items-center">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-[30%_30%_40%] gap-10 lg:gap-8 px-10">
        {/* Logo and Copyright */}
        <div className="flex flex-col items-start lg:px-10">
          {/* Logo */}
          <div className="mb-4">
            <div className="w-10 h-10 flex items-center justify-center">
              <img className="h-8 w-auto" src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Lgog.svg" alt="Logo"/>
            </div>
          </div>
        ...
        <div className="px-10">
          ...
          <form className="flex">
            <input type="email" placeholder="Your email address" className="w-full px-4 py-2 text-gray-900 rounded-l-md focus:outline-none"/>
            <button type="submit" className="px-4 py-2 bg-green-500 text-[#D9DBE1] rounded-r-md hover:bg-green-600">
              <svg
